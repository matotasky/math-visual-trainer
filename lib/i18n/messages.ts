  ...
  sk: {
    ...
    child: {
      ...
      practiceRunner: {
        ...
        answerLabel: "Tvoja odpoveď",
        answerPlaceholder: "Ťukni na číslo. Na počítači môžeš použiť aj klávesnicu.",
        clearAnswer: "Vymazať odpoveď",
        checkAnswer: "Odoslať",
    ...
    parent: {
      ...
      settings: {
        title: "Nastavenia",
        description: "Upravte rodičovský PIN, denný cieľ dieťaťa, mieru časového tlaku a základné rodičovské voľby.",
        loading: "Načítavam nastavenia...",
        loadError: "Nastavenia sa nepodarilo načítať. Skontrolujte pripojenie a Firebase pravidlá.",
        noChildrenTitle: "Zatiaľ tu nie je žiadne dieťa",
        noChildrenDescription: "Denný cieľ a časový tlak môžete nastaviť po vytvorení detského profilu.",
        createChildButton: "Vytvoriť dieťa",
        childSectionTitle: "Dieťa a učenie",
        childSectionDescription: "Nastavte denný cieľ v úlohách a citlivosť časového tlaku pre vybrané dieťa.",
        childSelectorLabel: "Aktívne dieťa",
        dailyGoalLabel: "Denný cieľ v úlohách",
        dailyGoalHelp: "Odporúčanie pre MVP: 5 až 15 krátkych úloh denne. Maximum je 50.",
        timePressureLabel: "Časový tlak",
        timePressureHelp: "Pri neistote nechajte voľbu podľa levelu. Rýchlosť má prísť až po presnosti.",
        savePreferences: "Uložiť učenie",
        savingPreferences: "Ukladám...",
        preferencesSaved: "Nastavenia učenia sú uložené.",
        preferencesError: "Nastavenia učenia sa nepodarilo uložiť.",
        dailyGoalInvalid: "Denný cieľ musí byť celé číslo od 1 do 50.",
        timePressureOptions: {
          level_default: "Podľa aktuálneho levelu",
          none: "Bez časového tlaku",
          soft: "Jemný časový tlak",
          medium: "Stredný časový tlak",
          high: "Vyšší časový tlak"
        },
        pinSectionTitle: "Rodičovský PIN",
        pinSectionDescription: "PIN slúži ako detská bariéra pre rodičovskú časť. Nezobrazuje sa a ukladá sa iba ako hash.",
        currentPinLabel: "Aktuálny PIN",
        nextPinLabel: "Nový PIN",
        confirmPinLabel: "Potvrdiť nový PIN",
        pinPlaceholder: "4 až 8 číslic",
        changePin: "Zmeniť PIN",
        changingPin: "Mením PIN...",
        pinSaved: "PIN bol úspešne zmenený.",
        pinSaveError: "PIN sa nepodarilo zmeniť.",
        pinDigits: "PIN musí mať 4 až 8 číslic.",
        pinMismatch: "Nový PIN a potvrdenie sa musia zhodovať.",
        pinInvalid: "Aktuálny PIN nie je správny. Zostáva pokusov: {remaining}.",
        pinLocked: "PIN je dočasne zamknutý do {time}.",
        notificationsTitle: "Notifikácie",
        notificationsStatus: "Fáza 2",
        notificationsDescription: "Notifikácie sú pripravené architektonicky, ale v MVP nepoužívame platený email, SMS ani externé notifikačné služby.",
        webPushPlaceholder: "Budúca možnosť: Web Push v prehliadači.",
        fcmPlaceholder: "Budúca možnosť: Firebase Cloud Messaging na free-tier kompatibilné pripomienky.",
        manageChildrenTitle: "Detské profily",
        manageChildrenDescription: "Meno, nový profil a výber dieťaťa spravujete na samostatnej stránke Deti.",
        manageChildrenButton: "Spravovať deti"
      },
      children: {
        title: "Deti",
  ...
  en: {
    ...
    child: {
      ...
      practiceRunner: {
        ...
        answerLabel: "Your answer",
        answerPlaceholder: "Tap a number. On a computer, the keyboard works too.",
    ...
    parent: {
      ...
      settings: {
        title: "Settings",
        description: "Adjust the parent PIN, daily task goal, time-pressure preference, and core parent controls.",
        loading: "Loading settings...",
        loadError: "Could not load settings. Check your connection and Firebase rules.",
        noChildrenTitle: "No child profiles yet",
        noChildrenDescription: "Daily goal and time pressure can be configured after creating a child profile.",
        createChildButton: "Create child",
        childSectionTitle: "Child and learning",
        childSectionDescription: "Set the daily task goal and time-pressure sensitivity for the selected child.",
        childSelectorLabel: "Active child",
        dailyGoalLabel: "Daily goal in tasks",
        dailyGoalHelp: "MVP recommendation: 5 to 15 short tasks per day. Maximum is 50.",
        timePressureLabel: "Time pressure",
        timePressureHelp: "When unsure, keep the level default. Speed should come after accuracy.",
        savePreferences: "Save learning settings",
        savingPreferences: "Saving...",
        preferencesSaved: "Learning settings saved.",
        preferencesError: "Could not save learning settings.",
        dailyGoalInvalid: "Daily goal must be a whole number from 1 to 50.",
        timePressureOptions: {
          level_default: "Use current level default",
          none: "No time pressure",
          soft: "Soft time pressure",
          medium: "Medium time pressure",
          high: "Higher time pressure"
        },
        pinSectionTitle: "Parent PIN",
        pinSectionDescription: "The PIN is a child barrier for the parent section. It is never displayed and is stored only as a hash.",
        currentPinLabel: "Current PIN",
        nextPinLabel: "New PIN",
        confirmPinLabel: "Confirm new PIN",
        pinPlaceholder: "4 to 8 digits",
        changePin: "Change PIN",
        changingPin: "Changing PIN...",
        pinSaved: "PIN changed successfully.",
        pinSaveError: "Could not change PIN.",
        pinDigits: "PIN must be 4 to 8 digits.",
        pinMismatch: "New PIN and confirmation must match.",
        pinInvalid: "Current PIN is incorrect. Remaining attempts: {remaining}.",
        pinLocked: "PIN is temporarily locked until {time}.",
        notificationsTitle: "Notifications",
        notificationsStatus: "Phase 2",
        notificationsDescription: "Notifications are architecturally planned, but the MVP does not use paid email, SMS, or external notification services.",
        webPushPlaceholder: "Future option: browser Web Push.",
        fcmPlaceholder: "Future option: Firebase Cloud Messaging for free-tier compatible reminders.",
        manageChildrenTitle: "Child profiles",
        manageChildrenDescription: "Names, new profiles, and child selection are managed on the Children page.",
        manageChildrenButton: "Manage children"
      },
      children: {
        title: "Children",
